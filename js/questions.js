const questions25 = [
    ...
    [
        "Часто ли у вас возникает желание выяснить отношения с партнером?", ["Да, часто", "Нет", "Без родителей"],
        [
            "this.score.best++;",
    ...
    [
        "25Вы рассказываете родным, знакомым о проблемах в вашей семье?", ["Да", "Нет", "Частично"],
        [
    ...
    [
        "Вы используете секс в личной выгоде (например просили что то купить)", ["Нет", "Да", "Было несколько раз", ],
        [
            "this.score.honest++",
            "this.score.rsp++",
            "this.score.notSuitable++"
...
const questions35 = [
    ...
    [
        "35Вы росли в полной семье?", ["В моей семье оба родителя", "Только Мама", "Мама и отчим", "Без родителей", "Другое"],
        [
            "this.score.best++;",
            "this.score.notSuitable++",
            "this.score.rsp++;",
    ...
    [
        "35Вы рассказываете родным, знакомым о проблемах в вашей семье?", ["Да", "Нет", "Частично"],
        [
            "this.score.defective++",
            "this.score.best++",
            "this.score.notSuitable++"
...
const questions36 = [
    ...
    [
        "36Вы росли в полной семье?", ["В моей семье оба родителя", "Только Мама", "Мама и отчим", "Без родителей", "Другое"],
        [
            "this.score.best++;",
            "this.score.notSuitable++",
            "this.score.rsp++;",
    ...
    [
        "36Вы рассказываете родным, знакомым о проблемах в вашей семье?", ["Да", "Нет", "Частично"],
        [
            "this.score.defective++",
            "this.score.best++",
            "this.score.notSuitable++"
